...
const UserProfile = () => {
  ...
  return (
    user?.userName ? <div className="screen-root-container">
      <div className="profile-container">
        <div className="photo"></div>
        <div className="user-description">
          <div><strong>{user?.userName}</strong></div>
          <div>Some description for user. You can write about you in form, it will be saved in db. But unfortunately, I was unable to display it on the site.</div>
          <>
          </>
        </div>
